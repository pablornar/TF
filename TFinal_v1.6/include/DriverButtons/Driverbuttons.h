...
#include "DriverButtons/displaybuttons.h"	//libreria de botones
...
#include "DriverButtons/Buttonsconfiguracion.h"  //agrega la libreria de configuracion de lcd touch
