...
#define OFF    0
// ----------------------------------------------------------------------------
#include "Driverlcd/displaygraf.h"	//libreria general del display
//variables
struct D{
	uint16_t pin;
	GPIO_TypeDef* puerto;
...
extern void setBackColorRGB(uint8_t r, uint8_t g, uint8_t b);
...
extern void printRLC(char *st, int x, int y, int deg);
...
#include "Driverlcd/LCDFconfiguracion.h"  //agrega la libreria de configuracion de lcd
#include "Driverlcd/LCDFcomandos.h"    //agrega la libreria de comandos.
#include "Driverlcd/LCDFinicio.h"  //agrega la libreria de inicializacion de lcd
#include "Driverlcd/LCDFgraficos.h"  //agrega la libreria de graficos
